...
<body>
    <div class="container-fluid">
        ...
        <a href="formmobil.php" class="btn btn-primary">
                ...
                <div class="table-responsive">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td>
                                    <a href="updatemobil.php?id_mobil=' . $row["id_mobil"] . '" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                    <a href="hapusmobil.php?id_mobil=' . $row["id_mobil"] . '" class="btn btn-sm btn-danger" onclick="return confirm(\'Apakah Anda yakin ingin menghapus data ini?\');"><i class="fas fa-trash"></i> Hapus</a>
                                </td>';
                            echo '</tr>';
                        }
